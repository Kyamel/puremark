  ...
  void _incrementCounter() {
    setState(() {
      ...
      // called again, and so nothing would appear to happen.
        // Invocar a função getSomeStructure
      Pointer<Utf8> pointer = bindings.getSomeStructure();

      // Converter o ponteiro UTF-8 para uma string Dart
      String json = pointer.toDartString();

      // Exibir o JSON serializado
      print("JSON serializado: $json");

      // Decodificar o JSON e extrair o valor de x
      Map<String, dynamic> decodedJson = jsonDecode(json);
      int x = decodedJson['x'];

      if (_counter == 0){
          _counter = bindings.addInt(_counter, x);
      }
      else{
          bindings.changeState();
          pointer = bindings.getSomeStructure();
      ...
      bindings.freeSomeStructure(pointer);
